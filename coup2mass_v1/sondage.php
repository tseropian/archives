...
<tr>
	<td>
		...
		<tr>
			<td>
				<div align="center">
				<!-- D�but du sondage � ins�rer -->
				<script language="JavaScript" src="http://www.webdonline.com/fr/services/sondageWeb/SondageSubmit.asp?id=306250&son=22288"></script>
				<form name="sondagewebd" method="POST" target="SondageWebd">
				<!-- \\\\ tableau qui donne la bordure -->
				<table cellpadding="0" cellspacing="0" border="0" bgcolor="#000000">
				<tr>
           				<td valign="top" align="center">
						<!-- \\\\ Tableau int�rieur du sondage -->
                					<table border="0" cellpadding="4" cellspacing="1">
                    					
                    <tr>
                      <td bgcolor="#000000"><font face="verdana" size=2 color="#ffffff">
                	 
                			<BR><b>Votre sexe</b><br>
                		
                				   <input type="radio" name="42103" value="229556"> Masculin<BR>
                				
                				   <input type="radio" name="42103" value="229557"> Feminin<BR>
                				<br>
                 
                			<BR><b>Quel est votre �ge ?</b><br>
                		
                			<select name="42104"> 
                		
                				   <option value="229558">  0-10
						   <option value="229560">  16-20
                				   <option value="229559">  11-15
                				   <option value="229561">  21-25
                				   <option value="229562">  26-30
                				   <option value="229563">  31-35
                				   <option value="229564">  36-40
                				   <option value="229565">  40-50
                				   <option value="229566">  51 & +
                			</select>
                		<br>
                 
                			<BR><b>Comment avez vous d�couvert le groupe?</b><br>
                		
                			<select name="42105"> 
                		
                				   <option value="229567">  Sur le sampler d'un magazine
                				   <option value="229568">  Par un pote
                				   <option value="229569">  A la radio
                				   <option value="229570">  A la m�diath�que
                				   <option value="229571">  Sur le net
                				   <option value="229572">  A un concert
                				   <option value="229573">  Dans la rue
                				   <option value="229574">  Autre
                			</select>
                		<br>
                 
                			<BR><b>Quel est votre album pr�f�r�</b><br>
                		
                			<select name="42106"> 
                		
                				   <option value="229575">  Le Bien Etre Et La Paix
                				   <option value="229576">  Live
                				   <option value="229577">  Contraddiction
                				   <option value="229578">  De Cercle En Cercle
                			</select>
                		<br>
                 
                			<BR><b>Avez vous d�j� vus mass en concert ?</b><br>
                		
                				   <input type="radio" name="42107" value="229579"> oui<BR>
                				
                				   <input type="radio" name="42107" value="229580"> non<BR>
                				<br>
                 		</td>
				<td valign="top">
                			<BR><b>Comment avez vous d�couvert Coup2Mass?</b><br>
                		
                				   <input type="radio" name="42110" value="229587"> Par un lien<BR>
                				
                				   <input type="radio" name="42110" value="229588"> Par un webring<BR>
                				
                				   <input type="radio" name="42110" value="229589"> Par une connaissance<BR>
                				
                				   <input type="radio" name="42110" value="229591"> Par un moteur de recherche<BR>
                				
                				   <input type="radio" name="42110" value="229592"> Par hasard<BR>
                				
                				   <input type="radio" name="42110" value="229590"> Par un forum<BR>
                				<br></td></tr><tr><td colspan=2>
                
                		<br><br>
                		<div align="center">
                		<input type="button" value="Votez!" onClick="showresults(306250,22288,1)"><br>
                		<a href="javascript:showresults(306250,22288,0)">R�sultats et archives</a><br>
                		</div>
                	  </font></td>
                    </tr>
                </table>
